...
class Agent:
    ...
    def save_models(self):
        ...
        self.critic_1.save_weights(self.critic_1.chkpt_file)
        self.critic_2.save_weights(self.critic_2.chkpt_file)
        self.value.save_weights(self.value.chkpt_file)
        self.target_value.save_weights(self.target_value.chkpt_file)

    def load_models(self):
        print('... loading models ...')
        self.actor.load_weights(self.actor.chkpt_file)
        self.critic_1.load_weights(self.critic_1.chkpt_file)
        self.critic_2.load_weights(self.critic_2.chkpt_file)
        self.value.load_weights(self.value.chkpt_file)
        self.target_value.load_weights(self.target_value.chkpt_file)

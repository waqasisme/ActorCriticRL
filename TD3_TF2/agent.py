...
class Agent:
    def __init__(self, alpha, beta, input_dims, tau, env, gamma=0.99, update_actor_interval=2, warmup=1000,
                num_actions=2, max_size=1e6, layer1_size=400, layer2_size=300, batch_size=100, noise=0.1):
        self.gamma = gamma
        self.tau = tau
        ...
        self.actor = ActorNetwork(layer1_size, layer2_size, num_actions=num_actions, name='actor')
        ...
        self.target_actor = ActorNetwork(layer1_size, layer2_size, num_actions=num_actions, name='target_actor')
